...
<template>
  <AppointmentLayout>
    <div class="flex flex-col w-3/5 h-6/7 justify-center items-center bg-neutral-100 rounded-3xl">
      <div class="flex h-1/6 w-full justify-center items-center flex-col">
        ...
        <div class="flex h-2/5 w-4/5 border-t-[2px] border-t-neutral-800">
          </div>
      </div>
      <div class="flex flex-col h-5/6 w-full p-">
